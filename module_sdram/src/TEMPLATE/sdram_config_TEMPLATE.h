#ifndef SDRAM_CONFIG_TEMPLATE_H_
#define SDRAM_CONFIG_TEMPLATE_H_
 ...
 */
#ifdef SDRAM_REFRESH_MS_TEMPLATE
#define SDRAM_REFRESH_MS SDRAM_REFRESH_MS_TEMPLATE
#else
#define SDRAM_REFRESH_MS 64
#endif

#ifdef SDRAM_REFRESH_CYCLES_TEMPLATE
#define SDRAM_REFRESH_CYCLES SDRAM_REFRESH_CYCLES_TEMPLATE
#else
 ...
 */
#ifdef SDRAM_ACCEPTABLE_REFRESH_GAP_TEMPLATE
#define SDRAM_ACCEPTABLE_REFRESH_GAP SDRAM_ACCEPTABLE_REFRESH_GAP_TEMPLATE
#else
 ...
 */
#ifdef SDRAM_CMDS_PER_REFRESH_TEMPLATE
#define SDRAM_CMDS_PER_REFRESH SDRAM_CMDS_PER_REFRESH_TEMPLATE
#else
 ...
 */
#ifdef SDRAM_EXTERNAL_MEMORY_ACCESSOR_TEMPLATE
#define SDRAM_EXTERNAL_MEMORY_ACCESSOR SDRAM_EXTERNAL_MEMORY_ACCESSOR_TEMPLATE
#else
 ...
 */
#ifdef SDRAM_CLOCK_DIVIDER_TEMPLATE
#define SDRAM_CLOCK_DIVIDER SDRAM_CLOCK_DIVIDER_TEMPLATE
#else
 ...
 */
#ifdef SDRAM_MODE_REGISTER_TEMPLATE
#define SDRAM_MODE_REGISTER SDRAM_MODE_REGISTER_TEMPLATE
#else
#define SDRAM_MODE_REGISTER 0x0027 //CAS 2
#endif

#endif /* SDRAM_CONFIG_TEMPLATE_H_ */
