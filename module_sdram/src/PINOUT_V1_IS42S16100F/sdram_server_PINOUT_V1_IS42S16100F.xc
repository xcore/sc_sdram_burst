...
#include "sdram_config_PINOUT_V1_IS42S16100F.h"
...
void sdram_init_PINOUT_V1_IS42S16100F(struct sdram_ports_PINOUT_V1_IS42S16100F &p) {
  timer T;
  int t;
...
static inline void sdram_refresh_PINOUT_V1_IS42S16100F(unsigned ncycles, struct sdram_ports_PINOUT_V1_IS42S16100F &p) {
  unsigned t;
...
void sdram_block_write_PINOUT_V1_IS42S16100F(unsigned buffer, unsigned word_count, buffered port:32 dq,
    out buffered port:8 we, out buffered port:32 ras, unsigned term_time);
void sdram_block_read_PINOUT_V1_IS42S16100F(unsigned buffer, unsigned word_count, buffered port:32 dq,
    out buffered port:8 ctrl, unsigned term_time, unsigned st, out buffered port:32 ras);
void sdram_short_block_read_PINOUT_V1_IS42S16100F(unsigned buffer, unsigned word_count, buffered port:32 dq,
    out buffered port:8 ctrl, unsigned term_time, unsigned st, out buffered port:32 ras);
...
static inline void sdram_write_PINOUT_V1_IS42S16100F(unsigned row, unsigned col, unsigned bank,
    unsigned buffer, unsigned word_count, struct sdram_ports_PINOUT_V1_IS42S16100F &ports) {
  unsigned t;
  unsigned stop_time;
  unsigned jump;
  unsigned rowcol;
 ...
 if(SDRAM_EXTERNAL_MEMORY_ACCESSOR)
  ...
  sdram_block_write_PINOUT_V1_IS42S16100F(buffer, jump, ports.dq_ah, ports.we, ports.ras, stop_time);
}

#pragma unsafe arrays
static inline void sdram_read_PINOUT_V1_IS42S16100F(unsigned row, unsigned col, unsigned bank,
    unsigned buffer, unsigned word_count, struct sdram_ports_PINOUT_V1_IS42S16100F &ports) {
 ...
 if(SDRAM_EXTERNAL_MEMORY_ACCESSOR)
  ...
  if (word_count < 4) {
    ...
    sdram_short_block_read_PINOUT_V1_IS42S16100F(buffer, word_count, ports.dq_ah, ports.we, stop_time, t+3, ports.ras);
    ...
    sdram_block_read_PINOUT_V1_IS42S16100F(buffer, jump, ports.dq_ah, ports.we, stop_time, t+3, ports.ras);
  }
}

#define CUR_IMPL PINOUT_V1_IS42S16100F
