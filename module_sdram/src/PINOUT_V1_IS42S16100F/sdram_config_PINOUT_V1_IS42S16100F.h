#ifndef SDRAM_CONFIG_PINOUT_V1_IS42S16100F_H_
#define SDRAM_CONFIG_PINOUT_V1_IS42S16100F_H_
 ...
 */
#ifdef SDRAM_REFRESH_MS_PINOUT_V1_IS42S16100F
#define SDRAM_REFRESH_MS SDRAM_REFRESH_MS_PINOUT_V1_IS42S16100F
#else
#define SDRAM_REFRESH_MS 64
#endif

#ifdef SDRAM_REFRESH_CYCLES_PINOUT_V1_IS42S16100F
#define SDRAM_REFRESH_CYCLES SDRAM_REFRESH_CYCLES_PINOUT_V1_IS42S16100F
#else
 ...
 */
#ifdef SDRAM_ACCEPTABLE_REFRESH_GAP_PINOUT_V1_IS42S16100F
#define SDRAM_ACCEPTABLE_REFRESH_GAP SDRAM_ACCEPTABLE_REFRESH_GAP_PINOUT_V1_IS42S16100F
#else
 ...
 */
#ifdef SDRAM_CMDS_PER_REFRESH_PINOUT_V1_IS42S16100F
#define SDRAM_CMDS_PER_REFRESH SDRAM_CMDS_PER_REFRESH_PINOUT_V1_IS42S16100F
#else
 ...
 */
#ifdef SDRAM_EXTERNAL_MEMORY_ACCESSOR_PINOUT_V1_IS42S16100F
#define SDRAM_EXTERNAL_MEMORY_ACCESSOR SDRAM_EXTERNAL_MEMORY_ACCESSOR_PINOUT_V1_IS42S16100F
#else
 ...
 */
#ifdef SDRAM_CLOCK_DIVIDER_PINOUT_V1_IS42S16100F
#define SDRAM_CLOCK_DIVIDER SDRAM_CLOCK_DIVIDER_PINOUT_V1_IS42S16100F
#else
 ...
 */
#ifdef SDRAM_MODE_REGISTER_PINOUT_V1_IS42S16100F
#define SDRAM_MODE_REGISTER SDRAM_MODE_REGISTER_PINOUT_V1_IS42S16100F
#else
#define SDRAM_MODE_REGISTER 0x0027 //CAS 2
#endif

#endif /* SDRAM_CONFIG_PINOUT_V1_IS42S16100F_H_ */
