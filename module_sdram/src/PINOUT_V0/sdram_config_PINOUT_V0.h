#ifndef SDRAM_CONFIG_PINOUT_V0_H_
#define SDRAM_CONFIG_PINOUT_V0_H_
 ...
 */
#ifdef SDRAM_REFRESH_MS_PINOUT_V0
#define SDRAM_REFRESH_MS SDRAM_REFRESH_MS_PINOUT_V0
#else
#define SDRAM_REFRESH_MS 32
#endif

#ifdef SDRAM_REFRESH_CYCLES_PINOUT_V0
#define SDRAM_REFRESH_CYCLES SDRAM_REFRESH_CYCLES_PINOUT_V0
#else
#define SDRAM_REFRESH_CYCLES 2048
#endif
 ...
 */
#ifdef SDRAM_ACCEPTABLE_REFRESH_GAP_PINOUT_V0
#define SDRAM_ACCEPTABLE_REFRESH_GAP SDRAM_ACCEPTABLE_REFRESH_GAP_PINOUT_V0
#else
 ...
 */
#ifdef SDRAM_CMDS_PER_REFRESH_PINOUT_V0
#define SDRAM_CMDS_PER_REFRESH SDRAM_CMDS_PER_REFRESH_PINOUT_V0
#else
...
#define SDRAM_EXTERNAL_MEMORY_ACCESSOR SDRAM_EXTERNAL_MEMORY_ACCESSOR_PINOUT_V0
#else
 ...
 */
#ifdef SDRAM_CLOCK_DIVIDER_PINOUT_V0
#define SDRAM_CLOCK_DIVIDER SDRAM_CLOCK_DIVIDER_PINOUT_V0
#else
 ...
 */
#ifdef SDRAM_MODE_REGISTER_PINOUT_V0
#define SDRAM_MODE_REGISTER SDRAM_MODE_REGISTER_PINOUT_V0
#else
#define SDRAM_MODE_REGISTER 0x0027 //CAS 2
#endif

#endif /* SDRAM_CONFIG_PINOUT_V0_H_ */
